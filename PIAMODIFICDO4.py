                        ...
                        try:
                            with sqlite3.connect("PIA.db") as conn:
                                ...
                                if regclie:
                                    ...
                                    print("\n***No se encontraron clientes por favor registre uno, regrese al menú principal***")
                                    break
                        except Error as e:
                            print(e)
                        except:
                            ...
                            while True:
                                ...
                                while True:
                                    try: #try para prevenir error de mal fecha ingresada
                                        fecha_capturada=input("\nIngrese la fecha para la reservacion: ")
                                ...
                                if regreserva:
                                    if regclie:
                                        if regsala:
                                            ...
                                            print("*" * 120)
                                            for idreserv ,nombrereservacion,fechareservacion in regreserva:
                                                for idcliente, clientes in regclie:
